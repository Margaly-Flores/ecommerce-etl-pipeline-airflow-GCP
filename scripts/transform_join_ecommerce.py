...
if __name__ == "__main__":
    ...
    # SparkSession con BigQuery connector
    spark = (
    ...
    # Temporal GCS path para BigQuery connector
    bigquery_temp_dir = "bq-temp-gds-bucket"

    # 1) Leer la tabla products
    products_df = (
    ...
    # 2) transformar productos: añadir price_tier basados en precio
    ...
    # 4) Transformar orders: añadir total_price = precio después de join, pero extraer order_dt
    ...
    # 5) Join products ↔ orders en product_id
    ...
    # 6) Write en BigQuery en append mode
    (
